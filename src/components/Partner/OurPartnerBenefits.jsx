      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="relative border border-purple-500 rounded-3xl p-6">
            ...
            <span className="text-2xl capitalize">{OurBenefitsText.text2}</span>
          </div>
          ...
          <div className="relative border gap-8 border-purple-100 rounded-3xl p-10">
            ...
            <span className="text-2xl capitalize ">{OurBenefitsText.text3}</span>
          </div>
          ...
          <div className="relative border border-purple-100 rounded-3xl p-6">
            ...
            <span className="text-2xl capitalize">{OurBenefitsText.text4}</span>
          </div>
          ...
          <div className="relative border border-purple-100 rounded-3xl p-6">
            ...
            <span className="text-2xl capitalize">{OurBenefitsText.text5}</span>
          </div>
        </div>

        {/* Image and Partner Stats */}
        <div className="relative flex justify-center items-center">
          <img src={png1} alt="png1" className="w-full max-w-[464px] h-auto" />
          <div className="absolute bottom-0 right-0 border border-purple-100 rounded-3xl p-6 h-44 w-56">
            ...
            <span className="capitalize text-2xl text-gray-500">Partner joined</span>
          </div>
