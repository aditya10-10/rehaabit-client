  ...
  return (
    <div className="flex flex-col items-center justify-center px-5 py-10 sm:px-10 sm:py-16 md:px-16 md:py-20 lg:px-20">
      <div className="flex flex-col items-center justify-center gap-5">
        <h2 className="text-2xl sm:text-3xl md:text-4xl capitalize font-bold text-center">
          Open Positions
        </h2>
        <p className="text-base sm:text-sm md:text-lg text-gray-500 text-center w-[90%] sm:w-[75%] md:w-[60%] lg:w-[50%]">
          ...
          Rehaabit, please apply to one of the job opportunities below.
        </p>
