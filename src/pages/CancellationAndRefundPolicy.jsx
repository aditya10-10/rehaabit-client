      ...
      <div className="p-6 max-w-5xl bg-white shadow-md rounded-md my-10">
        ...
        <section className="mb-6" style={{ fontFamily: "Roboto, sans-serif" }}>
          <p>
            ...
            order or request a refund for services booked through our platform.
        ...
        <section className="mb-6" style={{ fontFamily: "Roboto, sans-serif" }}>
          ...
          <ul className="list-disc pl-5 mt-2">
            ...
            <li>
              <strong>Within 3 hours of the service:</strong> A cancellation fee
              of up to ₹50 may apply. No fee if a professional is not assigned.
            </li>
          </ul>
          <p className="mt-2">
            The cancellation fee goes directly to the professional. Their time
            is reserved for the service, and they cannot accept another job for
            the reserved time.
          </p>
        ...
        <section className="mb-6" style={{ fontFamily: "Roboto, sans-serif" }}>
          ...
          <p>
            ...
            the customer or service provider in accordance with the Cancellation
            Policy. Refunds will not be provided for services that have already
            been rendered.
          </p>

          <h3 className="text-xl font-medium mt-4 mb-1">2.2 Refund Process</h3>
          <p>
            Once a cancellation is confirmed, refunds will be processed within
            7-10 business days. The refund will be credited back to the original
            mode of payment.
          </p>
        </section>
        ...
        <section className="mb-6" style={{ fontFamily: "Roboto, sans-serif" }}>
          ...
          <p className="mt-2">
            Services booked during promotional events or special offers may have
            different cancellation and refund policies. Please refer to the
            terms and conditions of the promotion for more details.
          </p>
        </section>
        ...
        <section className="mb-6" style={{ fontFamily: "Roboto, sans-serif" }}>
          ...
          <p>
            ...
            and Refund Policy at any time without prior notice. Any changes will
            be effective immediately upon posting on the Platform. Please review
